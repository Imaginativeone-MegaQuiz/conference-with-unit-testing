...
export class ConferenceApp {
  ...
  appPages: PageInterface[] = [
    { title: 'MegaQuiz', name: 'TabsPage', component: TabsPage, tabComponent: MegaquizPage, index: 0, icon: 'information-circle' },
  ...
  loggedInPages: PageInterface[] = [
    { title: 'MegaQuiz', name: 'TabsPage',    component: TabsPage,    icon: 'information-circle' },
